...
tree1 + 
  ...
  geom_range("length_0.95_HPD", color="plum2", size=2, alpha=.5) + 
...
ggsave("mrca_tree.svg", width = 10, height = 5)
ggsave("mrca_tree.png", width = 10, height = 5)
