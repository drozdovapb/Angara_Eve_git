...
ggsave("18S_Irk.svg", width = 8, height = 4)
...
ggsave("both_Irkutsk.svg", width = 9, height=5)
...
ggsave("both_upper.svg", width = 9, height=5)
...
ggsave("both_Bratsk.svg", width = 9, height=5)